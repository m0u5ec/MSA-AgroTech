...
Вариант в целом можно было бы рассмотреть для MVP - за счет переиспользования существующего функционала он, возможно, был бы экономнее. Но в перспективе требуется отдельная система с возможностью расширения и потенциалом внешнего использования.
