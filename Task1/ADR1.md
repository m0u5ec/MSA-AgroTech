...
[Текущий контекст выглядит следующим образом](C1.puml)
...
[Предлагаемый целевой MVP-контекст](C1_2.puml) 

### <a name="_bjrr7veeh80c"></a>**Альтернативы**

[Альтернативный целевой контекст с переиспользованием](C1_1.puml)
